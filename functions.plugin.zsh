...
# Date:   Wed Sep 16 22:14:01 CET 2020
#
...
### Functions (network) ###
myip() { curl home-ghillani.ddns.net ; }           # myip:         Public facing IP Address
...
numFiles() { echo "Files in this dir:"$(ls -1 | wc -l) ; }             # numFiles:     Count of non-hidden files in current dir
